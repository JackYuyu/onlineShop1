...
- (void)_setupTransformBubbleConstraints {
    ...
    [self.transformButton mas_updateConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.transTitle.mas_bottom).offset(3);
        make.bottom.mas_equalTo(self.backgroundImageView.mas_bottom).offset(-self.margin.bottom);
        make.centerX.mas_equalTo(self.backgroundImageView.mas_centerX).offset(0);
    }];
}

...
- (void)setShadowAnimationView
{
    ...
    cart.goodsId=
    _narrowedModalView = [[LPSemiModalView alloc] initWithSize:CGSizeMake(Main_Screen_Width, 360) andBaseViewController:self.navigationController];
...
- (void)setDetailView
{
    ...
    _detailViewController.featureBlock = ^(DCFeatureItem *features) {
        ...
        [_featureAttr addObject:features];
        _narrowedModalView.featureAttr=_featureAttr;
